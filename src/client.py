...
def __parse_args():
    ...
    parser.add_argument("--cmd", action="store", default="get",
                        choices=["put", "plist", "get", "delete", "select", "keys"], help="Operation")
...
def main():
    ...
    if args.key and args.value and args.cmd in ("put", "plist"):
